...
def load_raw_domains(k, cerebellum="combo"):
  list_file = "../../lists/{}/lists_k{:02d}.csv".format(cerebellum, k)
...
def optimize_list_len(k, cerebellum="combo"):
    ...
    lists, circuits = load_raw_domains(k, cerebellum=cerebellum)
    ...
    op_lists.to_csv("../../lists/{}/lists_k{:02d}_oplen_logreg.csv".format(cerebellum, k), index=None)
